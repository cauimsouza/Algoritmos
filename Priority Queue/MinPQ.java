 ...
 * @description Implementation of a minimum priority queue using binary heap as data
 *              structure.
 * @date        03/01/2017
 */
public class MinPQ<Key extends Comparable<Key> >{
    ...
    /**
     * 
     * @return The mimimum element in the priority queue and deletes it
     ...
     * @return  Returns true if the first element is considered greater than
     *          the second element.
     */
