...
public class MinPQ<Key extends Comparable<Key> > implements Iterable<Key> {
    ...
    /**
     * Returns and deletes a minimum element in the priority queue
     * 
     * @return a minimum element in the priority queue and deletes it
    ...
    /**
     * Returns a minimum element in the priority queue
     * 
     * @return a minimum element in the priority queue
     * @throws NoSuchElementException if this priority queue is empty
     */
    public Key min(){
        if(isEmpty()) throw new NoSuchElementException("Priority queue underflow");
     ...
     * @return  true if the first element is considered greater than
     *          the second element.
     */
